...
const normalizeService = (service: Partial<Service> & { id: string }): Service => {
  ...
  return {
    ...
    shortDescription: requiredTrimmed(service.shortDescription) || requiredTrimmed(service.summary) || undefined,
    summary: requiredTrimmed(service.summary) || requiredTrimmed(service.shortDescription) || undefined,
    ...
    visualMedia: requiredTrimmed(service.visualMedia) || undefined,
    image: requiredTrimmed(service.image) || undefined,
    media: requiredTrimmed(service.media) || undefined,
